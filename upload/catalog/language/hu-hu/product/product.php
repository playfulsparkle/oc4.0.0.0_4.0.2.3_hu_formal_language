...
$_['text_subscription_trial']    = '%s minden %d %s(s) %d alkalommal történő fizetés után ';
$_['text_subscription_duration'] = '%s minden %d %s(s) %d alkalommal történő fizetés';
$_['text_subscription_cancel']   = '%s minden %d %s(s) a lemondásig';
$_['text_day']                   = 'nap';
$_['text_week']                  = 'hét';
